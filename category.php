...
<head>
    ...
    <!-- Title Page-->
    <title>Notice Board System | Category</title>
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <input type="text" id="catname" name="catname" placeholder="Category Name" class="form-control" required="true">
...
?>
                ...
                <tr>
                  ...
                  <td><a href="category.php?catid=<?php echo $row['id'];?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger btn-sm">Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
} else{?>
